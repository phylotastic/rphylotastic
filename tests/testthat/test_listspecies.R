...
#  result <- InsertListSpecies(userid, listObj)
...
#  result <- ReplaceListSpecies(userid, accesstoken, listid, speciesObj)
#  msg<-result$message
#  expect_equal(msg, "Success")
#})
...
#  result <- UpdateListSpecies(userid, accesstoken, listid, listObj)
#  msg <-result$message
#  expect_equal(msg, "Success")
#})
