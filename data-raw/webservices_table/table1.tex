...
\hspace{1em}GNRD\_wrapper\_file & \multirow{-3}{7cm}{\raggedright\arraybackslash using Global Names Recognition and Discovery (GNRD) services}\\

\hspace{1em}TaxonFinder\_wrapper\_URL; & \\

\hspace{1em}TaxonFinder\_wrapper\_text & \multirow{-2}{7cm}{\raggedright\arraybackslash using Taxon Finder}\\
...
\hspace{1em}Compare\_trees & \multirow{-2}{7cm}{\raggedright\arraybackslash Compare two phylogenetic trees symmetrically}\\
...
\hspace{1em}Remove\_list; & \multirow{-5}{7cm}{\raggedright\arraybackslash Save, publish, access, remove or update lists of names.}\\
\bottomrule
\end{tabu}
\endgroup{}
\end{document}
